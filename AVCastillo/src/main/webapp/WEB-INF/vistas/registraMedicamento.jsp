...
$("#id_registrar").click(function () {	
	...
	if (validator.isValid()){
		$.ajax({ 								//el Ajax no refresca toda la página sino sectores que yo decida dentro.
			type: 'POST' ,
                ...
                des_med:{
                    ...
                    validators:{
                        ...
                        stringLength: {
                            min: 8,
                            max: 50,
                            message: 'La descripción debe estar entre 8 y 50 caracteres'
                        },
                    }
                },
                pre_med:{
                ...
                can_med:{
                    ...
                    validators:{
                        ...
                        stringLength: {
                            min: 1,
                            max: 2,
                            message: 'La cantidad máxima es de 99'
                        },
                    }
                },
                fecha_elab:{
                    ...
                    validators:{
                    	notEmpty: {
                            message: 'La fecha de elaboración es obligatorio'
                       },
                       regexp: {
